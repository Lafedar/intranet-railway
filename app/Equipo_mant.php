...
class Equipo_mant extends Model
{
    ...
    public function scopeRelaciones_index ($query)
    {
        ...
        'equipos_mant.uso as uso', 'localizaciones.nombre as localizacion', 'area.nombre_a as area', 'equipos_mant.uso as uso', 'tipos_equipos.id as id_tipo',
        'localizaciones.id as id_localizacion', 'area.id_a as id_area', 'tipos_equipos.nombre as nombre_tipo', 'equipos_mant.num_serie as num_serie');
    }
