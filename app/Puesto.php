 ...
 public function scopeRelaciones($query)
    {
    	return  $query -> leftjoin('personas','puestos.persona','personas.id_p')
                    	...
                    	->select('puestos.id_puesto as id_puesto','puestos.desc_puesto as desc_puesto','personas.nombre_p as nombre','personas.apellido as apellido','area.nombre_a as area','puestos.obs as obs');
    }
