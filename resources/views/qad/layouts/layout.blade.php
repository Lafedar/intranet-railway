...
<head>
  ...
  <script language="JavaScript" src="{{ URL::asset('/js/jquery.dataTables.min.js') }}" type="text/javascript"></script>
******************leo******************************
  <script language="JavaScript" src="{{ URL::asset('/js/tableToExcel.js') }}" type="text/javascript"></script>

<script language="JavaScript" src="{{ URL::asset('/js/exportTaToEx.js') }}" type="text/javascript"></script>
  
  <script language="JavaScript" src="{{ URL::asset('/js/fcalcular.js') }}" type="text/javascript"></script>
***************************************************

  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  
    <a class="navbar-brand" href="qad"> <img class="logo" src="{{ URL::to('/img/logo.png') }}" height="40"> </a>
