                ...
                <tbody>
                    @foreach($parameters as $parametro)
                        @if(auth()->user()->hasRole('administrador'))
                            @if($parametro->origen == "Mantenimiento" || $parametro->origen == "RRHH")
                            ...
                            @endif
                        @elseif(auth()->user()->hasRole('Jefe-Mantenimiento'))
                        ...
                        <div class="modal-body">
                            ...
                            @if(auth()->user()->hasRole('rrhh'))
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="origen" name="origen" value="RRHH" 
                                        readonly>
                                </div>
                            @elseif(auth()->user()->hasRole('Jefe-Mantenimiento'))
                                <div class="form-group">
