...
<div class="form-group col-md-12">
  <div class="row">
    <div class="col">
      ...
      <input type="hidden" name="id_vieja" id="id_vieja" value="{{ $area->id }}">
      <input type="text" name="id" class="form-control" id="id" autocomplete="off" value="{{$area->id}}" min="5" max="5" required>
    </div>
    <div class="col">
