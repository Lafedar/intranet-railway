...
<div class="modal fade" id="agregar" role="dialog" aling="center">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ action('CostoController@store_costo') }}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="date" name="fecha" class="form-control col-md-5" step="1" min="2019-01-01"
