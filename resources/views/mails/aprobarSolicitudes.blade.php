    ...
    <body>
        <div class="container">
            ...
            <div class="container-button">
                <a href="http://intranet.lafedar.net/aprobar_solicitud/{{ $idSolicitud }}" class="button" style="background-color: #007bff;">Aprobar</a>
                <br><br>
                <a href="http://intranet.lafedar.net/solicitudes?idsolicitud={{ $idSolicitud }}&source=email" class="button" style="background-color: #e74c3c;">Reclamar</a>
                <br><br>
                <a href="http://intranet.lafedar.net/solicitudes?idsolicitud={{ $idSolicitud }}&source=detalle" class="button" style="background-color: #f39c12;">Detalle</a>
            </div>
            <p>Saludos,</p>
