...
<div class="modal fade" id="agregar" role="dialog" aling="center">
  <div class="modal-dialog">
    <div class="modal-content">           
      <form action="{{ action('PublicDocumentationController@store_public_documentation') }}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group col-md-12">
                ...
                <br>
                <label for="title"><strong>Documento:</strong></label>
