...
<head>
    ...
    <style>
        ...
        table {
            ...
            /* Espacio entre filas (10px vertical) */
    ...
    <div class="container mt-4">
        @if(session('success'))
            <div class="alert alert-success"
                style="text-align: center; display: inline-block; position: fixed; top: 5%; left: 50%; transform: translate(-50%, -50%);">
                {{ session('success') }}
            </div>
        @endif
            ...
            <table class="table table-bordered table-striped text-center">
                <thead>
                    ...
                    <a href="{{ route('cursos.instancias.index', ['cursoId' => $curso->id]) }}"
                        class="btn btn-secondary" style="margin-bottom: 10px;" id="volver">Volver</a>
                                ...
                                @if($persona->estadoEnrolado)
                                    ...
                                    <form
                                        ...
                                        <button type="submit" style="border: none; background: none; padding: 0;"
                                            title="Desuscribir"><img src="{{ asset('storage/cursos/eliminar.png') }}"
                                                alt="Eliminar" style="width:27px; height:27px;"></button>
