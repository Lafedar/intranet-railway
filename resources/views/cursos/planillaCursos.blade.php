  ...
  <style>
    ...
    @media print {
      ...
      .pagina:first-of-type {
        page-break-before: auto; /* No insertar salto de página antes de la primera */
      }
      table {
        width: 100%;
      ...
      <div class="contenedor" style="max-width: 900px; margin: 20px auto; padding: 20px;">
        ...
        <div class="tabla" style="width: 100%; border: 2px solid black; border-collapse: collapse; display: table;">
          ...
          <div class="fila-1" style="display: table-row; width: 100%; border-bottom: 2px solid black;">
            ...
            <div class="celda-derecha" style="display: table-cell; width: 40%; border-left: none; padding: 2px; text-align: right; font-size: 20px;"></div>
          </div>
          ...
          <div class="fila-2" style="display: table-row; width: 80%;">  
            ...
            <!-- Celda derecha -->
            <div class="celda-derecha-2" style="display: table-cell; position: relative; padding: 2px; text-align: center; font-size: 20px; width: 30%;"> 
            ...
            <tbody>
              @foreach ($paginaInscriptos as $enrolamiento)
                <tr>
                  ...
                  {{ $enrolamiento['fecha_enrolamiento'] ? \Carbon\Carbon::parse($enrolamiento['fecha_enrolamiento'])->format('d/m/Y') : '' }}
