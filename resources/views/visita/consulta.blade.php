  ...
  <table class="table table-striped table-bordered ">
    ...
    <tbody>
        ...
        <tr>
            ...
            @endif
            @if($visita->activa == 1)
            <td align="center"><h5 style="color:green">Activa</h5></td>
            @else
            <td align="center"><h5>Finalizada</h5></td>
            @endif
            <td align="center" width="80">
                <a href="#" class="btn btn-primary btn-sm"  data-toggle="modal" data-dni="{{$visita->dni_ext}}" data-target="#foto_externo"  type="submit">Ver foto</a>
            </td>
        </tr>                    
        @endforeach  
        @endif  
