...
<div class="container text-center" >
  ...
  <div class="row">
    ...
    <br><br>
    <div class="col-md-3">
      <a  href="/internos"> <img  src="{{ URL::to('/img/internos.png') }}" height="140"></a>
    </div>

    <div class="col-md-3" >
      <a  href="{{('/permisos')}}"> <img src="{{ URL::to('/img/permisos.png') }}" height="140"> </a>
    </div>

    <div class="col-md-3">
      <a  href="{{('/sistemas')}}"> <img src="{{ URL::to('/img/sistemas.png') }}" height="140"> </a>
    </div>

    <div class="col-md-3">
      <a  href="{{('/documentos')}}"> <img src="{{ URL::to('/img/documentacion.png') }}" height="140"> </a>
    </div>
    ...
    <div class="col-md-3">
      <a  href="{{('/persona')}}"> <img  src="{{ URL::to('/img/recepcion.png') }}" height="140"></a>
    </div>

    <div class="col-md-3">
      <a  href="{{('/empleado')}}"> <img src="{{ URL::to('/img/personal.png') }}" height="140"> </a>
    </div>

    <div class="col-md-3">
      <a  href="{{('/medico')}}"> <img src="{{ URL::to('/img/medico.png') }}" height="140"> </a>
    </div>

    <div class="col-md-3">
      <a  href="{{('/visitas')}}"> <img src="{{ URL::to('/img/guardia.png') }}" height="140"> </a>
    </div>
    
    {{-- <div class="col-md-3">
      <a  href="{{('/qad')}}"> <img src="{{ URL::to('/img/qad.png') }}" height="140"> </a>
    </div>
    --}}
  </div>
