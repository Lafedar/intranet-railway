          ...
          <div class="col-md-12">
            ...
            <div class="row"> 
              ...
              <div class="col-md-3">
                ...
                <input type="number" name="disco" class="form-control"  autocomplete="off" id="disco" min="0" value="{{old('disco')}}">
              </div>
              <div class="col-md-3">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="number" name="pulgadas" class="form-control"  autocomplete="off" id="pulgadas" min="0" value="{{old('pulgadas')}}">
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class ="col-md-4">
                ...
                <select type="text" name="id_red" class="form-control" id="id_red"></select>
              </div>
              <div class="col-md-3">
