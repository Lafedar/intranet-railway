...
<!-- alertas -->
<div class="container-fluid" id="producciones-container">
  <div class="content">
  ...
  <button class="btn btn-info"  data-toggle="modal" data-target="#agregar" id="producciones-btn"> Agregar</button>
  <div>
    <h1>
      <div class="form-inline pull-right">
        <form method="GET">
          <div class="form-group">
            <div class="form-group">
              <h6>ID:</h6>
              <input type="text" name="id_produccion" class="form-control" id="id_produccion"
                value="{{$id_produccion}}">
            </div>
            &nbsp
            <div class="form-group">
              <h6>Título:</h6>
              <input type="text" name="titulo_produccion" class="form-control" id="titulo_produccion"
                value="{{$titulo_produccion}}">
            </div>
            &nbsp
            <div class="form-group">
              <h6>Fecha:</h6>
              <input type="date" name="fecha_produccion" class="form-control" id="fecha_produccion"
            ...
            <input type="text" name="obs_produccion" class="form-control" id="obs_produccion"
              value="{{$obs_produccion}}">
            &nbsp
  ...
  <div id="producciones-table">
    ...
    @endforeach
      ...
      <a href="{{ Storage::url($produccion->pbix) }}"  title="Descargar Archivo"
    ...
    @endif
      ...
      <button  data-id="{{$produccion->id}}" data-titulo="{{$produccion->titulo}}"
      data-fecha="{{$produccion->fecha}}" data-obs="{{$produccion->obs}}" data-pbix="{{$produccion->pbix}}"
      data-frecuencia="{{$produccion->frecuencia}}" data-toggle="modal" data-target="#editar" id="icono" title="Editar"><img src="{{ asset('storage/cursos/editar.png') }}" alt="Editar" id="img-icono"></button>
    @endcan
      @can('eliminar-produccion')
      <a href="{{url('destroy_produccion', $produccion->id)}}"  title="Eliminar"
