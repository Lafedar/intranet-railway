...
<div id="estados-container">
  ...
  <button class="btn btn-info" onclick='fnOpenModalStore()' data-toggle="modal" data-target="#agregar_estado"
    id="btn-agregar"> Agregar estado</button>
  <!-- tabla de datos -->
  <div>
    <table>
      <thead>
      ...
      <tr class="text-center">
        ...
        <td width="90"><button class="btn btn-info btn-sm" onclick='fnOpenModalUpdate("{{$estado->id}}")'
          title="update" data-nombre="{{$estado->nombre}}" id="icono" title="Editar"><img
