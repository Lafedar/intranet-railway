...
<div class="container-fluid" id="documentos-planos-container">
    ...
    @endif
    <button class="btn btn-info" data-toggle="modal" data-target="#agregar" id="planos-btn-agregar"> Agregar</button>
    <div>
        <h1>
            <div class="form-inline pull-right">
                <form method="GET">
                    <div class="form-group">
                        ...
                        <input type="text" name="id_plano" class="form-control col-md-1" id="id_plano"
                            value="{{$id_plano}}">
                        &nbsp
                        <label>
                            <h6><b>Título:</b></h6>
                        </label>
                        <input type="text" name="titulo_plano" class="form-control col-md-3" id="titulo_plano"
                            value="{{$titulo_plano}}">
                        &nbsp
                        <label>
    ...
    <div id="planos-table">
                    ...
                    @foreach($planos as $plano)
                        <tr>
                            ...
                            <td width="222">
                                <div>
                                    @if($plano->pdf != null)
                                        <a href="{{ Storage::url($plano->pdf) }}" class="btn btn-primary btn-sm"
                                            title="Descargar PDF original" data-position="top" data-delay="50"
                                            data-tooltip="Descargar PDF original" download>PDF Original</a>
                                    @else
                                        <a class="btn btn-secondary btn-sm" data-position="top" data-delay="50" download>PDF
                                            Original</a>
                                    @endif

                                    @if($plano->pdf_firmado != null)
                                        <a href="{{ Storage::url($plano->pdf_firmado) }}" class="btn btn-primary btn-sm"
                                            title="Descargar PDF firmado" data-position="top" data-delay="50"
                                            data-tooltip="Descargar PDF firmado" download>PDF Firmado</a>
                                    @else
                                        <a class="btn btn-secondary btn-sm" data-position="top" data-delay="50" download>PDF
                                            Firmado</a>
                                    @endif
                                ...
                                <div align="center">
                                    @if($plano->dwg != null)
                                        <a href="{{ Storage::url($plano->dwg) }}" class="btn btn-primary btn-sm"
                                            title="Descargar DWG" data-position="top" data-delay="50" data-tooltip="Descargar DWG"
                                            download>DWG</a>
                                    @else
                                    ...
                                    @if($plano->ctb != null)
                                        <a href="{{ Storage::url($plano->ctb) }}" class="btn btn-primary btn-sm"
                                            title="Descargar CTB" data-position="top" data-delay="50" data-tooltip="Descargar CTB"
                                            download>CTB</a>
                                    @else
                                    ...
                                    <button class="btn btn-info btn-sm" data-id="{{$plano->id}}"
                                        ...
                                        data-obs="{{$plano->obs}}" data-pdf="{{$plano->pdf}}"
        ...
        {{ $planos->links('pagination::bootstrap-4') }} <!--paginacion-->
