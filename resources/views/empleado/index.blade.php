...
<div>
  ...
  <div class="col-sm-12">
    ...
    @endif
      ...
      <a href="{{ route('empleado.cursos', $empleado->id_p) }}" title="Ver Cursos"><img
      src="{{ asset('storage/cursos/ver.png') }}" alt="Ver Cursos" id="img-icono"></a>
      ...
      title="Eliminar"><img src="{{ asset('storage/cursos/eliminar.png') }}" alt="Eliminar"
      id="img-icono"></button>
      </form>
