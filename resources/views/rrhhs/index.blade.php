            ...
            <tr>
              ...
              <td width="110">
                <div>
                  ...
                  @if($rrhh->pbix != null)
                    <a href="{{ Storage::url($rrhh->pbix) }}" class="btn btn-primary btn-sm" title="Descargar Archivo" data-position="top" data-delay="50" data-tooltip="Descargar Archivo" download>Descargar</a>
                  @else
                ...
                <div aling="center">
                  @can('editar-rrhh')
                    <button class="btn btn-info btn-sm" data-id="{{$rrhh->id}}" data-titulo="{{$rrhh->titulo}}" data-fecha="{{$rrhh->fecha}}" data-obs="{{$rrhh->obs}}" data-pbix="{{$rrhh->pbix}}" data-frecuencia="{{$rrhh->frecuencia}}" data-toggle="modal" data-target="#editar"> Editar</button>
                  @endcan
                  @can('eliminar-rrhh')
                    <a href="{{url('destroy_rrhh', $rrhh->id)}}" class="btn btn-danger btn-sm" title="Borrar" onclick="return confirm ('Está seguro que desea eliminar el archivo?')"data-position="top" data-delay="50" data-tooltip="Borrar">X</a>
                  @endcan
                </div>
              </td>
            </tr>
